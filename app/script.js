  ...
  if (predict) {
    tf.tidy(function() {
     ...
     STATUS_CONTAINER.innerHTML = "";
      for (let i in predictionArray){
        STATUS_CONTAINER.innerHTML = STATUS_CONTAINER.innerHTML + "<div><h3>"+CLASS_NAMES[i]+": </h3><progress value="+predictionArray[i]+"></progress></div><br>" ;
      }
    });
